...
public class FlowerBedForgeSpell extends AbstractSpell {
    private final ResourceLocation spellId = new ResourceLocation(FrierenFlightCommon.MODID, "flower_bed");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        if (!level.isClientSide && level instanceof ServerLevel serverLevel) {
            ...
            com.frierenflight.entity.FlowerBedForgeEntity flowerBed = new com.frierenflight.entity.FlowerBedForgeEntity(serverLevel, entity.getX(), entity.getY(), entity.getZ(), radius, duration, spellLevel);
            ...
            for (Player playerTarget : players) {
                playerTarget.addEffect(new MobEffectInstance(ModForgeEffects.FLOWER_BLESSING.get(), duration, amplifier, false, true, true));
            }
        }
