...
/**
 * ==============================================================================
 * MASTER 3D VFX PIPELINE: MEGUMIN EXPLOSION MAGIC (FORGE 1.20.1)
 * ==============================================================================
 */
public class ExplosionVFXRenderer {

    public static final ResourceLocation TEX_DARK_PURPLE_RING   = new ResourceLocation("frieren_flight", "textures/vfx/megumin_dark_purple_ring.png");
    public static final ResourceLocation TEX_PURPLE_RING        = new ResourceLocation("frieren_flight", "textures/vfx/megumin_purple_ring.png");
    public static final ResourceLocation TEX_MAGIC_CIRCLE       = new ResourceLocation("frieren_flight", "textures/vfx/megumin_magic_circle.png");
    public static final ResourceLocation TEX_RAINBOW_ECLIPSE    = new ResourceLocation("frieren_flight", "textures/vfx/megumin_star_eclipse_rainbow.png");
    public static final ResourceLocation TEX_EXPLOSION_STAR     = new ResourceLocation("frieren_flight", "textures/vfx/megumin_explosion_star.png");
    public static final ResourceLocation TEX_WHITE_STAR_EXPLODE = new ResourceLocation("frieren_flight", "textures/vfx/megumin_white_star_explode.png");
    public static final ResourceLocation TEX_SHOCKWAVE          = new ResourceLocation("frieren_flight", "textures/vfx/megumin_shockwave.png");
    public static final ResourceLocation TEX_SHOCKWAVE_AFTER    = new ResourceLocation("frieren_flight", "textures/vfx/megumin_shockwave_after.png");
    public static final ResourceLocation TEX_BEAM_PLASMA        = new ResourceLocation("frieren_flight", "textures/vfx/explosion_beam_plasma.png");
    public static final ResourceLocation TEX_CRATER             = new ResourceLocation("frieren_flight", "textures/vfx/explosion_crater_fracture.png");
    ...
    public static void renderCrossStarBillboard(PoseStack poseStack, VertexConsumer builder, float size, int alpha) {
        ...
        addVertex(builder, matrix, pose, -half, -half, 0, 0.0f, 1.0f, 255, 255, 255, alpha, 0, 0, 1);
        addVertex(builder, matrix, pose,  half, -half, 0, 1.0f, 1.0f, 255, 255, 255, alpha, 0, 0, 1);
        addVertex(builder, matrix, pose,  half,  half, 0, 1.0f, 0.0f, 255, 255, 255, alpha, 0, 0, 1);
        addVertex(builder, matrix, pose, -half,  half, 0, 0.0f, 0.0f, 255, 255, 255, alpha, 0, 0, 1);

        addVertex(builder, matrix, pose, 0, -half, -half, 0.0f, 1.0f, 255, 255, 255, alpha, 1, 0, 0);
        addVertex(builder, matrix, pose, 0, -half,  half, 1.0f, 1.0f, 255, 255, 255, alpha, 1, 0, 0);
        addVertex(builder, matrix, pose, 0,  half,  half, 1.0f, 0.0f, 255, 255, 255, alpha, 1, 0, 0);
        addVertex(builder, matrix, pose, 0,  half, -half, 0.0f, 0.0f, 255, 255, 255, alpha, 1, 0, 0);

        addVertex(builder, matrix, pose, -half, 0, -half, 0.0f, 1.0f, 255, 255, 255, alpha, 0, 1, 0);
        addVertex(builder, matrix, pose, -half, 0,  half, 0.0f, 0.0f, 255, 255, 255, alpha, 0, 1, 0);
        addVertex(builder, matrix, pose,  half, 0,  half, 1.0f, 0.0f, 255, 255, 255, alpha, 0, 1, 0);
        addVertex(builder, matrix, pose,  half, 0, -half, 1.0f, 1.0f, 255, 255, 255, alpha, 0, 1, 0);
    }
    ...
    public static void renderCylinderTube(PoseStack poseStack, VertexConsumer builder, float radius, float height, int segments, float vOffset, int r, int g, int b, int a) {
        ...
        for (int i = 0; i < segments; i++) {
            ...
            addVertex(builder, matrix, pose, x1, 0, z1, u1, v2, r, g, b, a, x1 / radius, 0, z1 / radius);
            addVertex(builder, matrix, pose, x2, 0, z2, u2, v2, r, g, b, a, x2 / radius, 0, z2 / radius);
            addVertex(builder, matrix, pose, x2, height, z2, u2, v1, r, g, b, a, x2 / radius, 0, z2 / radius);
            addVertex(builder, matrix, pose, x1, height, z1, u1, v1, r, g, b, a, x1 / radius, 0, z1 / radius);
        }
    }
    ...
    public static void renderHorizontalDisc(PoseStack poseStack, VertexConsumer builder, float radius, float yOffset, int r, int g, int b, int a) {
        ...
        addVertex(builder, matrix, pose, -radius, yOffset,  radius, 0.0f, 1.0f, r, g, b, a, 0, 1, 0);
        addVertex(builder, matrix, pose,  radius, yOffset,  radius, 1.0f, 1.0f, r, g, b, a, 0, 1, 0);
        addVertex(builder, matrix, pose,  radius, yOffset, -radius, 1.0f, 0.0f, r, g, b, a, 0, 1, 0);
        addVertex(builder, matrix, pose, -radius, yOffset, -radius, 0.0f, 0.0f, r, g, b, a, 0, 1, 0);
    ...
    public static void renderIntersectingCrossPlanes(PoseStack poseStack, VertexConsumer builder, float width, float height, float vOffset, int alpha) {
        for (int i = 0; i < 3; i++) {
            ...
            addVertex(builder, matrix, pose, -halfW, 0, 0, 0.0f, 2.0f + vOffset, 255, 140, 50, alpha, 0, 0, 1);
            addVertex(builder, matrix, pose,  halfW, 0, 0, 1.0f, 2.0f + vOffset, 255, 140, 50, alpha, 0, 0, 1);
            addVertex(builder, matrix, pose,  halfW, height, 0, 1.0f, 0.0f + vOffset, 255, 220, 120, alpha, 0, 0, 1);
            addVertex(builder, matrix, pose, -halfW, height, 0, 0.0f, 0.0f + vOffset, 255, 220, 120, alpha, 0, 0, 1);
    ...
    private static void addVertex(VertexConsumer builder, Matrix4f matrix, PoseStack.Pose pose,
