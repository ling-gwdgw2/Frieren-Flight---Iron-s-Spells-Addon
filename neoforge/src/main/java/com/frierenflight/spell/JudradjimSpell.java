...
public class JudradjimSpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(FrierenFlightCommon.MODID, "judradjim");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        if (!level.isClientSide && level instanceof ServerLevel serverLevel) {
            ...
            JudradjimPillarEntity pillar = new JudradjimPillarEntity(serverLevel, entity, damage, 7.5f);
